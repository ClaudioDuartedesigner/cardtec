...
<form method="POST" class="dv-form">
     <img src="https://card.tec.br/img/instagram.png" width="50px;">
    <h1 class="label-title">Inserir Instagram</h1>
    <input type="hidden" name="id_cliente" value="<?php echo $id_card ?>">  
    <input type="hidden" name="img_instagram" value="<?php echo "https://card.tec.br/img/instagram.png" ?>">
    <input type="text" name="link_instagram">
    <button type="submit" name="salvar" value="salvar" class="bt-green">Adicionar</button>
    <?php 
    if(isset($_POST['id_cliente'])){
        $create = new Card();
        $create->createlinkInstagram();
    }
    ?>
    </form>
</section>    
